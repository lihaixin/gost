...
speederv2 -s -l0.0.0.0:4096 -r 127.0.0.1:$SERVER_PORT --mode $MODE --fec $FEC_OPTIONS -k $PASSWORD --timeout $TIMEOUT --mtu=$MTU --fifo /root/fifo.file --interval $INTERVAL $OPTION
echo ok
